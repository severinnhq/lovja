...
>
  <div className="flex flex-col justify-between items-center w-full ">
    ...
    >
      ...
      🎁 BONUS #1 – Jednostavno ispunite obrazac i dobit ćete besplatan, ekskluzivan pregled za transformaciju osmijeha / CBCT / oralnu higijenu!
      </p>
    </motion.div>
...
>
  <div className="text-3xl min-[360px]:text-4xl xl:text-5xl 2xl:text-6xl 
    ...
    Savršen <span className="text-white">osmijeh</span>
  </div>
